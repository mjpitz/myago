...
serverID and clock. It works by taking a millisecond level timestamp, shifting
its value left 8 bits, and or it with the server ID. The leading byte can be
used to expand this representation later on.
